                            ...
                            <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                                ...
                                <form id="contactForm">
                                    <div className="mb-6">
                                        ...
                                        <div className="mx-0 mb-1 sm:mb-4">
                                            <label htmlFor="email" className="pb-1 text-xs uppercase tracking-wider">Your email address</label>
                                            <input
                                            type="email"
                                            id="email"
                                            autoComplete="email"
                                    ...
                                    <div className="text-center">
                                        <button type="submit" className="w-full bg-blue-800 hover:bg-accent-text text-white px-6 py-3 font-xl rounded-md sm:mb-0">
                                        Send Message
                                        </button>
                                    </div>
                                    </form>
